            ...
            <div className="divide-y divide-slate-50 dark:divide-slate-800">
              {schedules
                ...
                .map(s => {
                  ...
                  return (
                    <div key={s.id} className="p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-all group">
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div className="flex gap-2">
                           <button onClick={() => handlePaySchedule(s)} className="p-3 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 rounded-xl hover:bg-emerald-600 dark:hover:bg-emerald-500 hover:text-white transition-all shadow-sm"><CheckCircle2 className="w-5 h-5" /></button>
